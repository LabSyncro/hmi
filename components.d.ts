...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    DetailInfoSearch: typeof import('./src/components/app/device/DetailInfoSearch.vue')['default']
    DeviceDetail: typeof import('./src/components/app/device/DeviceDetail.vue')['default']
