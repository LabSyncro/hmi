...
const handleDeviceScan = async (input: string) => {
  try {
    ...
    toast({
      title: "Thành công",
      description: "Đã thêm thiết bị vào danh sách sửa chữa",
    });
  } catch (error) {
    toast({
      title: "Lỗi",
...
const updateMaintenanceOutcome = (
...
const completeMaintenance = async () => {
  ...
  try {
    ...
    toast({
      title: "Thành công",
      description: "Đã hoàn tất sửa chữa thiết bị",
    });
    resetForm();
  } catch (error) {
                ...
                >
                  ...
                  <div class="col-span-3">
                    <Select
                      ...
                      class="flex-grow"
                      @update:modelValue="
                        updateMaintenanceOutcome(item, item.maintenanceOutcome)
                      "
                    >
                      <SelectTrigger
              ...
              <div class="space-y-2">
                ...
                <div class="flex justify-between">
                  ...
                  <span class="text-sm font-medium text-blue-600"
                    >{{
                      maintenanceDetails.repairStatus.needsReplacement
                    }}
                    cái</span
                  >
                </div>
